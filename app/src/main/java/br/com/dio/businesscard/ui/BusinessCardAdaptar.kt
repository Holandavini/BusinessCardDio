...
// Classe que irá pegar os dados que estão vindo da lista e listar na tela do usuário
class BusinessCardAdaptar : ListAdapter<BusinessCard, BusinessCardAdaptar.ViewHolder>(DiffCallback()){
    ...
    inner class ViewHolder(private val binding: ItemBusinessCardBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(item: BusinessCard){
            ...
            binding.mcvContent.setCardBackgroundColor(Color.parseColor(item.customBackgroud))
